...
import 'package:wechat_assets_picker/src/widget/editor/constants.dart';
import 'package:wechat_assets_picker/src/widget/editor/preview_img.dart';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      precacheImage(
          assetPath != null
              ...
              : NetworkImage(networkUrl!) as ImageProvider<Object>,
          context)
          .whenComplete(() {
        if (!mounted) return;
        isPreCached = true;
